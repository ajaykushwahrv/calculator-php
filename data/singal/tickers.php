...
if (isset($rvtickersdata['error']) || empty($rvtickersdata) || !is_array($rvtickersdata)) {
    ...
    <div style="position: relative; height: 48px;">
        ...
        <iframe src="<?= $rvtickersdata['domainName']; ?>/<?= $rvtickersdata['directoryName']; ?>/<?= $rvtickersdata['toolscat']; ?>/<?= $rvtickersdata['urlName']; ?>?apikey=<?= $rvtickersdata['apikey']; ?>&primarycolor=000&secondarycolor=a0cd3a&bgcolo=0000" frameBorder={0} width="100%" height="48px"></iframe>
    </div>
<?php } ?>