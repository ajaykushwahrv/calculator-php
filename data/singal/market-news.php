...
if (isset($rvMarketNewsdata['error']) || empty($rvMarketNewsdata) || !is_array($rvMarketNewsdata)) {
  ...
  <iframe src="<?= $rvMarketNewsdata['domainName']; ?>/<?= $rvMarketNewsdata['directoryName']; ?>/<?= $rvMarketNewsdata['toolscat']; ?>/<?= $rvMarketNewsdata['urlName']; ?>?apikey=<?= $rvMarketNewsdata['apikey']; ?>&primarycolor=293895&secondarycolor=a0cd3a&bgcolo=0000" frameBorder={0} height=210px; width="100%"></iframe>
<?php } ?>