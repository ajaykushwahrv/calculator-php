...
<iframe src="<?= $rvIPONewsdata['domainName']; ?>/<?= $rvIPONewsdata['directoryName']; ?>/<?= $rvIPONewsdata['toolscat']; ?>/<?= $rvIPONewsdata['urlName']; ?>?apikey=<?= $rvIPONewsdata['apikey']; ?>&primarycolor=293895&secondarycolor=a0cd3a&bgcolo=0000" frameBorder={0} height=210px; width="100%"></iframe>
<?php } ?>