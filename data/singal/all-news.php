...
<iframe src="<?= $rvallNewsdata['domainName']; ?>/<?= $rvallNewsdata['directoryName']; ?>/<?= $rvallNewsdata['toolscat']; ?>/<?= $rvallNewsdata['urlName']; ?>?apikey=<?= $rvallNewsdata['apikey']; ?>&primarycolor=293895&secondarycolor=a0cd3a&bgcolo=0000" frameBorder={0} height=510px; width="100%"></iframe>
<?php } ?>