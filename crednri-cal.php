...
<head>
	...
	?>
    <title><?= $userinfo['name']?> | Financial Calculators</title>
    <meta content="" name="description">
    <meta content="" name="keywords">
    <link href="<?= $userinfo['base_url']; ?>/assets/css/calculator-style.css" rel="stylesheet"
...
<body data-page="tools">
    ...
    <section class="top-banner-section" style="background-image:url(<?= $userinfo['base_url']?>assets/images/banner/calculator.webp);">
        <div class="container">
...
switch($i) {
    case 1: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/line-chart.png" alt="Line Chart" />';
        break;
    case 2: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/calculator.png" alt="Calculator" />';
        break;
    case 3: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/stack-overflow.png" alt="Stack Overflow" />';
        break;
    case 4: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/pie-chart.png" alt="Pie Chart" />';
        break;
    case 5: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/universal-access.png" alt="Universal Access" />';
        break;
    case 6: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/history.png" alt="History" />';
        break;
    case 7: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/table.png" alt="Table" />';
        break;
    case 8: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/money.png" alt="Money" />';
        break;
}
?>
...
switch($i) {
    case 1: 
        ...
        break;
    case 2: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/gratipay.png" alt="Gratipay" />';
        break;
    case 3: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/graduation-cap.png" alt="Graduation Cap" />';
        break;
    case 4: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/clock.png" alt="Clock" />';
        break;
    case 5: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/pie-chart.png" alt="Pie Chart" />';
        break;
    case 6: 
        ...
        break;
    case 7: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/blind.png" alt="Blind" />';
        break;
    case 8: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/table.png" alt="Table" />';
        break;
    case 9: 
        ...
        break;
    case 10: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/home.png" alt="Home" />';
        break;
    case 11: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/car.png" alt="Car" />';
        break;
    case 12: 
        echo '<img src="'.$userinfo['base_url'].'assets/images/cal/vac.png" alt="Plane" />';
        break;
}
?>
